...
if settings.ENABLE_NUVIA_MAIL:
    nuvia_mail_urlpatterns = [
    ...
    nuvia_mail_urlpatterns = [
        path('nuvia-mail/', views.decommissioned_module_view, {'module': 'mail'}, name='nuvia_mail'),
        path('api/nuvia-mail/<path:unused>/', views.decommissioned_module_view, {'module': 'mail'}, name='nuvia_mail_disabled_api'),
    ]
...
urlpatterns = [
    ...
    *nuvia_mail_urlpatterns,
    ...
    # Reporting
    path('reporting/', views.reporting_view if settings.ENABLE_INTERNAL_TICKETS else views.decommissioned_module_view, {'module': 'tickets'} if not settings.ENABLE_INTERNAL_TICKETS else {}, name='reporting'),
    path('reporting/export/csv/', views.export_tickets_csv if settings.ENABLE_INTERNAL_TICKETS else views.decommissioned_module_view, {'module': 'tickets'} if not settings.ENABLE_INTERNAL_TICKETS else {}, name='export_tickets_csv'),
    ...
    path('tickets/', tickets_views.ticket_list_view if settings.ENABLE_INTERNAL_TICKETS else views.decommissioned_module_view, {'module': 'tickets'} if not settings.ENABLE_INTERNAL_TICKETS else {}, name='ticket_list'),
    path('tickets/<int:pk>/edit/', tickets_views.ticket_update_view if settings.ENABLE_INTERNAL_TICKETS else views.decommissioned_module_view, {'module': 'tickets'} if not settings.ENABLE_INTERNAL_TICKETS else {}, name='ticket_update'),
    path('tickets/<int:pk>/delete/', tickets_views.ticket_delete_view if settings.ENABLE_INTERNAL_TICKETS else views.decommissioned_module_view, {'module': 'tickets'} if not settings.ENABLE_INTERNAL_TICKETS else {}, name='ticket_delete'),
